...
class BuildExe:
    def __init__(self):
        ...
        # Name of program
        self.project_name = "poruipine_jmp"

        # Project url
        self.project_url = "https://github.com/kluchevsskay/porcupine_jmp"
        ...
        # Auhor of program
        self.author_name = "Me"
        self.author_email = "Alino4ka-Vasilisa@yandex.ru"
        self.copyright = "Copyright (c) 2020 kluchevsskay"

        # Description
        self.project_description = "MyApps Description"

        # Icon file (None will use pygame default icon)
        self.icon_file = 'Melissa_Jump2_R.png'

        # Extra files/dirs copied to game
        self.extra_datas = ["data", "main.py"]
